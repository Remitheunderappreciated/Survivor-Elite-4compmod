...
g_BridgeDestruction <-
{
	...
	tBridgeDestParams =
	{
		c1m2_streets =
		{
			trigger_origin = Vector(-1267, 2308, 72)
			trigger_maxs = Vector(240.765, 17.999, 150.520)
			trigger_mins = Vector()
			origin = Vector(-2401, -1620, 244)
			angles = QAngle(0, 270, 0)
		}
		
		c5m2_park =
		{
			trigger_origin = Vector(-7688, -5201, -98)
			trigger_maxs = Vector()
			trigger_mins = Vector(-8, -110, -150)
			origin = Vector(-3819, -6750, -248)
			angles = QAngle(0, 0, 0)
		}
