...
function Update()
{
	...
	{
		Say(null, " Shove zombies with grenades in hand, have fun! ",false);
	}

}

const VOMITJAR_MAX_USES = 9999999999
const EXTINGUISH_TIME = 99999999.9

enum ePipeBomb
{
	flDuration = 5.0
	flBeepMinInterval = 0.10
	flInitialBeepInterval = 0.50
	flIntervalDelta = 0.050
}
