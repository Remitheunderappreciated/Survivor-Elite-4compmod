...
g_PlaneCrash <-
{
	...
	PlaneCrashParams =
	{
		c1m1_hotel =
		{
			trigger_origin = Vector(1668, 6121, 2656)
			trigger_maxs = Vector(156.765, 17.999, 138.520)
			trigger_mins = Vector()
			origin = Vector(2302, 6850, 1544)
			angles = QAngle(0, 0, 0)
		}
		...
		c2m1_highway =
		{
			...
			trigger_mins = Vector()
			origin = Vector(1237, 7262, -722)
			angles = QAngle(0, 230, 0)
		}
		...
		c5m2_park =
		{
			trigger_origin = Vector(-6711, -1442, -106)
			trigger_maxs = Vector()
			trigger_mins = Vector(-8, -110, -150)
			origin = Vector(-4093, -3418, 8)
		...
		c8m1_apartment =
		{
			trigger_origin = Vector(2288, 994, 33)
			trigger_maxs = Vector(8, 60, 100)
			trigger_mins = Vector()
		...
		c8m4_interior =
		{
			trigger_origin = Vector(13347, 14516, 5656)
			trigger_maxs = Vector()
			trigger_mins = Vector(-8, -80, -120)
			origin = Vector(12564, 14664, 4968)
			angles = QAngle(0, 0, 0)
		}

		c9m1_alleys =
		{
			trigger_origin = Vector(-5703, -10250, 67)
			trigger_maxs = Vector(156.765, 17.999, 138.520)
			trigger_mins = Vector()
		...
		c10m4_mainstreet =
		{
			trigger_origin = Vector(-2330, -1743, -54)
			trigger_maxs = Vector(156.765, 17.999, 138.520)
			trigger_mins = Vector()
			origin = Vector(-1348, 616, -55)
