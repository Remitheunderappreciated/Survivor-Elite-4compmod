printl("Survivor Elite Overhaul for Versus is now running.");
...
function ScriptMode_Init( modename, mapname )
{
	...
	try
	{
		bScriptedModeValid = VSLU_ScriptMode_Init( modename, mapname );
	}
	catch (e)
	{
	}
...
IncludeScript("cbplus_s");	

IncludeScript("cbplus_i");